...
const FAQ = [
  ...
  { q: "C'est quoi l'abonnement mercredi ?", r: "Vous vous inscrivez une seule fois et votre place du mercredi est automatiquement réservée chaque semaine. Stripe prélève 8€ (ou 4€ pour les adhérents AUNL) chaque mercredi. Vous n'avez plus rien à faire." },
  { q: "Puis-je résilier l'abonnement quand je veux ?", r: "L'engagement minimum est de 4 semaines (1 mois). Après cette période, vous pouvez résilier à tout moment depuis la page 'Mon abonnement' ou par email. La résiliation prend effet à la fin de la semaine en cours." },
