...
const FAQ = [
  ...
  { q: "C'est quoi la formule illimitée ?", r: "Vous vous inscrivez une seule fois et votre place est automatiquement réservée chaque semaine. Stripe prélève 8€ (ou 4€ pour les adhérents AUNL) chaque semaine. Vous n'avez plus rien à faire." },
